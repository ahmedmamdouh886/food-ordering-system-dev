        ...
        return Order.builder()
                ...
                .failureMessages(orderEntity.getFailureMessages().isEmpty() ? new ArrayList<>() :
                        new ArrayList<>(Arrays.asList(orderEntity.getFailureMessages()
                                .split(FAILURE_MESSAGE_DELIMITER)))) // As you see, I wrap the response of Arrays.asList methods using a new ArrayList constructor because Arrays.asList methods creates an unmodifiable list, so I cannot add or remove elements from that list. When I wrap it with ArrayList constructor, it'll return a modifiable list so that I can modify this list in the business logic methods.
                .build();
    }
