...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    @Override
    @Transactional // Because I want to commit the database operation before firing the domain event.
    ...
    public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        // If this object is empty, it implies that the rollback operation is already completed, and a duplicate message from the kafka topic came.
        if (orderApprovalOutboxMessageResponse.isEmpty()) {
