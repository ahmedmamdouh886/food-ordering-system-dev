...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    private SagaStatus[] getCurrentSagaStatus(PaymentStatus paymentStatus) {
        // For completed payment saga status, it should be in started state.
        // Because when I trigger the payment service for the first time, saga is just started.
        // And when the payment completed event returned from the payment service, I still have the saga in the started state.
        //
        // For the canceled payment status, saga should be in processing state because when I call payment service to cancel, and roll back a payment I am in the middle of saga processing and the state is processing.
        //
        // And for failed payment status, It can either be started or processing.
