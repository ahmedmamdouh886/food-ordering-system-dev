    ...
    public void publish(
        ...
        try {
            ...
            kafkaProducer.send(
                    ...
                    sagaId, // The key for the kafka message. I set the saga id as key here, so the messages that belong to the same saga id will be in the same partition, and they will be ordered, because Kafka guarantees ordering in a single partition.
                    paymentRequestAvroModel, // The value for the kafka message.
