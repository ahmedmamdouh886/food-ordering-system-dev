...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    public PaymentEvent validateAndInitiatePayment(
        ...
        updateCreditHistory(payment, creditHistories, TransactionType.DEBIT); // Transaction type is debit because we are gonna subtract the payment amount from the customer credit amount.
