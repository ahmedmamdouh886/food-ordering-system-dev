...
@Slf4j
@SpringBootTest(classes = PaymentServiceApplication.class) // With this annotation when I run a test method, it'll actually start the spring context, so I can inject and use Spring beans.
public class PaymentRequestMessageListenerTest {
    ...
    void testDoublePaymentWithThreads() {
        ...
        // There are many solutions to implement multithreading in testing, ExecutorService is one of them.
