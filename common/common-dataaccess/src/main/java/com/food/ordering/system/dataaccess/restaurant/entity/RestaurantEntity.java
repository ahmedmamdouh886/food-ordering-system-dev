 ...
 * other domains.
 */
@Table(name = "order_restaurant_m_view", schema = "restaurant") // So as in the customer entity, I will use a materialized view from the restaurant database to query restaurant information in the order domain layer.
@Entity
